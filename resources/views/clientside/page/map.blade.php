									...
									<div class="">
										<div class="row">
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">WingSup</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Wingfoidivng</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">WingSurfing</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Kitesurfing</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Kitefoidivng</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">SnowKiteing</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Windsurfing</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Wingfoidivng</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Sup</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Yacht</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Catamaran</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Yawl</a>
											</div >
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Surfing</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Diving</a>
											</div>
											<div class="col-sm-4 mt-2 mb-2">
												<a class="btn btn-primary w-100" href="">Reset Filter</a>
											</div>
										</div>
