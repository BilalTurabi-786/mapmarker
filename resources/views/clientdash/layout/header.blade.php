          ...
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
                {{-- <li class="nav-item d-none d-lg-block">
                    <a class="nav-link nav-link-expand"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a>
                </li> --}}
                <li class="dropdown dropdown-notification nav-item ">
                    {{-- <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon fa fa-bell"></i><span class="badge badge-pill badge-primary badge-up">5</span></a> --}}
